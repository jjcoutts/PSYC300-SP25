...
you won't need the file path. Read the data into an object called
[**bl**]{.underline}.

```{r}
bl <- read.table(file = "/Users/jjcoutts/Library/CloudStorage/GoogleDrive-jjcoutts@umd.edu/My Drive/FlashDrive/Data/CSVs/binladen.csv", header = TRUE, sep = ",")
```
...
**Answer:** Boxplot; scatterplot is not appropriate because there are
...
-   Linearity: Reasonable, nothing wildly different about the boxes.

-   Homogeneity of variance: The range is approximately equal for the
    variables.
...
**Answer:** There correlation between support of the restriction of
Muslim's civil liberties and when they participated was not significant,
*r*(659) = .002, *t* = 0.051, *p* = .960.
